...
def main(args):
    ...
    with torch.no_grad():
        ...
        print(indices)
        indices = np.load("/workspace/wudang_vuc_3dc_afs/hujiakui/ntp4texture/image_codes/10ebed33cd164754865ae7f62d83559d.npy")
        indices = torch.from_numpy(indices).to("cuda")[1]
        print(indices)
